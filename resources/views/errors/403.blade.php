    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .head {
            ...
            background: linear-gradient(150deg, rgba(194, 100, 62, 0.16), rgba(255, 255, 255, 0));
        }
    ...
    <main class="card">
        ...
        <section class="body">
            <p>
                ...
                Jika seharusnya punya akses, silakan login dengan akun yang tepat atau hubungi pengelola sistem.
            </p>
            <div class="actions">
                <a class="btn btn-primary" href="{{ url('/') }}">Kembali ke Beranda</a>
                <a class="btn btn-secondary" href="{{ route('login') }}">Ke Halaman Login</a>
            </div>
        </section>
    </main>
</body>
